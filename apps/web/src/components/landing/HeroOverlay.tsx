    ...
    <>
      ...
      >
        <svg viewBox="0 0 355 110" className="w-full">
          <text x="0" y="75" fill="#1c1917" fontSize="72" fontWeight="500" letterSpacing="-2">
            {BRAND_NAME}
          </text>
        </svg>
      </motion.div>
      ...
      >
        ...
        <a href={CTA_HREF} data-login className="pointer-events-auto flex items-center gap-5 sm:gap-[50px]">
          ...
          <span className="text-[13px] font-medium text-stone-900 sm:text-[15px]">{NAV_ACTION_LABEL}</span>
        </a>
      </motion.div>
      ...
      >
        <p className="text-[12px] leading-[140%] font-medium tracking-[-0.04em] text-stone-900">{CAPTION}</p>
      </motion.div>
        ...
        <div className="mb-3 flex w-[252px] flex-col items-start sm:mb-8 sm:w-full">
          <div className="relative mb-2 h-5 w-5 sm:h-[30px] sm:w-[30px]">
            <svg viewBox="0 0 40 40" className="absolute inset-0 h-full w-full">
              <circle cx="20" cy="20" r="18.75" stroke="#1c1917" strokeWidth="2" fill="none" />
            </svg>
            <span
              ref={circleSymbolRef}
              className="absolute inset-0 flex items-center justify-center text-[10px] font-medium tracking-[-0.04em] text-stone-900 uppercase sm:text-[15px]"
            >
              8
            </span>
          </div>
          <p className="w-full text-center text-[20px] leading-none font-medium tracking-[-0.04em] text-stone-900 uppercase sm:text-[30px]">
            {PRODUCT_LABEL_LINE_1}
            <br />
            {PRODUCT_LABEL_LINE_2}
          </p>
        </div>
        <p className="text-center text-[60px] leading-none font-medium tracking-[-0.04em] text-stone-900 sm:text-[80px]">
          {PRODUCT_HERO_STAT}
        </p>
      </motion.div>
      ...
      >
        <span className="text-[72px] font-medium tracking-[-0.04em] text-stone-900 sm:text-[110px]">
          {CTA_LABEL}
        </span>
      </a>
      ...
      >
        <span className="text-[11px] font-medium tracking-[-0.02em] text-stone-900 uppercase sm:text-[13px]">
          {FOOTER_LEFT}
        </span>
        <span className="text-[11px] font-medium tracking-[-0.02em] text-stone-900 uppercase sm:text-[13px]">
          {FOOTER_RIGHT}
